...
class AIStartService {
    ...
    private func generatePrompt(for start: StartEntity, with laps: [LapEntity]) -> String {
        ...
        Ответ сформулируй в двух параграфах: первый – анализ текущего заплыва с объяснениями, второй – конкретные рекомендации по тренировкам и мотивация. По возможности нумеруй пункты. При выводе не используй жирный шрифт, не используй увеличенный шрифт, пиши всё одним шрифтом, одного размера.
        """
